...
class FileCache(private val context: Context) {
    ...
    companion object {
        ...
        private const val BASE_FOLDER = "ColdTs Client"
    }
     ...
     * Cherche dans Documents/ColdTs Client/{serverHost}/{relativePath}
     */
    ...
    /**
     * Enregistre les bytes dans Documents/ColdTs Client/{serverHost}/{relativePath}.
